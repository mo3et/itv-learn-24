...
func (x *Serv) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Serv) ProtoMessage() {}

func (x *Serv) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Serv.ProtoReflect.Descriptor instead.
func (*Serv) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{3}
}

func (x *Serv) GetClient() string {
	if x != nil {
		return x.Client
	}
	return ""
...
var file_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x22, 0x1e, 0x0a, 0x04, 0x53, 0x65, 0x72, 0x76, 0x12, 0x16, 0x0a, 0x06, 0x63, 0x6c, 0x69, 0x65,
	0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74,
	0x42, 0x22, 0x5a, 0x20, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2d, 0x6d, 0x69, 0x64, 0x64, 0x6c,
